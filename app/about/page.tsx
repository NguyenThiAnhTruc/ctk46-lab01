    ...
    <section className="mx-auto w-full max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm sm:p-10">
        ...
        <p className="mt-4 max-w-3xl leading-8 text-slate-600">
          Mình là Nguyễn Thị Ánh Trúc, sinh viên năm 4 ngành Công nghệ Thông tin
          tại Trường Đại học Đà Lạt. Mình thích xây dựng giao diện rõ ràng, học
          các công nghệ web mới và áp dụng chúng vào bài tập, dự án cá nhân.
        </p>
